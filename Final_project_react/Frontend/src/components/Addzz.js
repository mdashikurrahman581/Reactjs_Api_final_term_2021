  ...
  return (
    ...
    <div className="add">
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Form.Control type="text" placeholder="Enter The Product image" {...register("p_image", { required: true, minLength: 3, maxLength: 10 })}  />
      </Form.Group>
        ...
        <Form.Group>
          ...
          <Form.Control type="text" placeholder="Enter The Product descriptions" {...register("description", { required: true, minLength: 4, maxLength: 100 })} />
        </Form.Group>

        <br />
        <input type="submit" className="btn btn-outline-dark ms-2" value="Add Product" /><br /><br /><br />
